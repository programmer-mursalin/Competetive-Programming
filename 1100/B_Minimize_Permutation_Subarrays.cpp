...
void solve()
{
    ...
    //     else if ((a[1] == 1 && a[2] == 2) || (a[1] == 2 && a[2] == 1))
    //     {
    //         cout << "1 2" << endl;
    //         cheakmate
    //     }
    ...
    //     cheakmate
    // }
    // if ((pos_2 == 0 || pos_2 == n - 1) && (pos_n == n - 1 || pos_n == 0))
    // {
    ...
    // cout << pos_2 + 1 << " " << sw + 1 << endl;
    if (pos_n < min(pos_1, pos_2))
        cout << pos_n << " " << min(pos_1, pos_2) << endl;
    else if (pos_n > max(pos_1, pos_2))
        cout << pos_n << " " << max(pos_1, pos_2) << endl;
    else
        cout << 1 << " " << 1 << endl;
}
