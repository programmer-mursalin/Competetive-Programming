...
void solve()
{
    ...
    // If n is odd, doubling it may disrupt power of 6 checks
    // if (n % 3 != 0)
    // {
    //     pm cheakmate // not divisible by 3, impossible case
    // }
    ...
    while (n != 1)
    {
        ...
        {
            n *= 2; // If it's divisible by 3 but not 6, double it to get closer to a multiple of 6
        }
        else
        {
            pm cheakmate // If it's neither divisible by 3 nor reducible by multiplying, it's impossible
        }
        cnt++;
    }
